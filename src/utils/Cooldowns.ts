...
import DJSCommands, { CooldownConfig, InternalCooldownConfig } from "../../typings"
...
class Cooldowns {
    ...
    public async updateCooldown(cooldownUsage: InternalCooldownConfig, expires: Date) {
        const key = this.getKeyFromCooldownUsage(cooldownUsage)
    ...
    public getKey(cooldownType: CooldownTypes, userId: string, actionId: string, guildId?: string) {
